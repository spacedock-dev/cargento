...
| `web/next/next-sessions.js` | The sessions overview table: the untouched gate queue, the shared working attention ladder, the nearest-idle tail, measured activity and rate phrases, and the all-state shared-label caveat. |
