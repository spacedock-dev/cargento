...
default), or freezes a format 5 packet from a spec of recorded moments (`--freeze`), and collects the answer key for DEC-17's abstention check, one `judge` or `abstain` per
