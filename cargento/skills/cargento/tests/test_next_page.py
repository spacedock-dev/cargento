...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-notify.js": (
                5_909,
                "cb32aaae3f43d8fdb846ef7aa3cb3f680f9670eed1f6f87fb4edcf6aa3cd96eb",
            ),
            "next-chrome.js": (
                34_371,
        ...
        self.assertEqual(426_188, len(assembled))
        self.assertEqual(
            "23dbe78e821bba144fbaa7e04ebbbc8c425a180bd7813e3559482a0d6a7ec034",
