...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                131_694,
                "fe17e7675a8445953dc7e982e1e0abfd49bd15afba7a7037a098f0325510597f",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(776_387, len(assembled))
        self.assertEqual(
            "ff8db49fdbd51d37ad9c6665f02d7d92420a60b7147230380ef39bf6ba8c9e0e",
