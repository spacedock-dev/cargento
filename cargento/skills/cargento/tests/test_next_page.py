...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-observed.js": (
                30_592,
                "a54c26c67007ac727bd197628abec37c5884c85d976a60f002c5c7b6e1dd6fb1",
            ),
            "next-attention.js": (
                56_364,
        ...
        self.assertEqual(907_975, len(assembled))
        self.assertEqual(
            "a7ff3c5130b4b5568b44b055bcd424ff48cf834e980e00c283e5bbb9fca91c35",
