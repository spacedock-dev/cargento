...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-intent.js": (
                16_045,
                "e65fc2e0f117f91832e000b05ab75500cd2a1f38f77ba5fb29869a0e38d00cd6",
            ),
            "next-activity.js": (
                6_632,
        ...
        self.assertEqual(891_621, len(assembled))
        self.assertEqual(
            "adfd9822e9c9b492e1d049f4f201b063d2bfa6bdb85e30c48b06b4ccfdf943fc",
