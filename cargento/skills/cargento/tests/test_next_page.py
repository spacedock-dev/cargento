...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-observed.js": (
                31_136,
                "931161c99c97d8f72fd30e7c9b104546541979b82eb7c8dec17bb4682d32edf2",
            ),
            "next-attention.js": (
                56_558,
            ...
            "next-session.js": (
                36_503,
                "08099b828eb65c1c6c07f214a6e90c1cf18547249f5174e3aaf4379fb77d7bd1",
            ),
            "next-workstream.js": (
                18_659,
        ...
        self.assertEqual(911_238, len(assembled))
        self.assertEqual(
