...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-intent.js": (
                5_898,
                "37150eca130e2445922d6bde2e47d1ed537d341477ff4a64e5f8520dd397819d",
            ),
            "next-activity.js": (
                6_632,
            ...
            "next-cockpit.js": (
                144_723,
                "c268aab642486e7b6c22d93df4e245991519a70e38c811eb1321592e4862f8e4",
            ),
            "next-render.js": (
                8_901,
        ...
        self.assertEqual(799_615, len(assembled))
        self.assertEqual(
            "2f813e6a16e57f98602442c90da2ae9e65226730de50fd0b2f7a2ffdab6c7aa6",
