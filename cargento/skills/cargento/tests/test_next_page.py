...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-chrome.js": (
                15_973,
                "e0a5c84a2240f77499978a706fe5589799a4a817413343c4b1a7bbe8534c31d1",
            ),
            "next-sessions.js": (
                11_566,
        ...
        self.assertEqual(324_759, len(assembled))
        self.assertEqual(
            "5028ce9d58ccac5fbb33ad11f748320c1d295b08ba6997a92fed99b71baa7c91",
