...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-intent.js": (
                15_098,
                "2a1c509f1a4c73c201a934e90241d5e86036c9024cb3b62df3d44ff504e6a219",
            ),
            "next-activity.js": (
                6_632,
        ...
        self.assertEqual(890_674, len(assembled))
        self.assertEqual(
            "b563fce6479f370beb656988f7f757868cad440598e9e14d2fce2fbdd41fa8a5",
