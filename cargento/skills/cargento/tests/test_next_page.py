...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-observed.js": (
                30_890,
                "bb52193dbf91a2582eb28bdb769f91e9d91376e8876c2198fd1b90bfd500b9d1",
            ),
            "next-attention.js": (
                56_348,
            ...
            "next-cockpit.js": (
                125_599,
                "9ca571978f237fe69eb6e21a49c19ba24f5c82f63a5652b9d566e3d8ca9e60ed",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(96_427, len(styles))
        self.assertEqual(
            "7804697c37ac327fd25b1b1b7cdc6c868991ee405c51d212255b3ed295648678",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_page()
        self.assertEqual(768_544, len(assembled))
        self.assertEqual(
            "9d70eca220409995a971a0d4106828abaff3cefa0e703db36b0ef81b4fe5b8c1",
