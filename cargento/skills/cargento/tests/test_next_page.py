...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                108_709,
                "7c1f79d7585141e69657678ea1db77729e9651322866ae2fe5bea0dc97f6f231",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(746_822, len(assembled))
        self.assertEqual(
            "1f00024d43e2fadab2cde3dcc78f2075d8f2a10050fd240d52a579429fdbc12d",
