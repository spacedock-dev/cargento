...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-observed.js": (
                30_818,
                "c4349ddb18c783a375f832897c348534626a74a37fa940cf240e5225ee63568c",
            ),
            "next-attention.js": (
                56_364,
            ...
            "next-cockpit.js": (
                196_180,
                "8a80754b1ffcfacd523480ee5f8b21a5028c269cb04b5c3e4fd3080d1addf562",
            ),
            "next-render.js": (
                8_960,
        ...
        self.assertEqual(898_151, len(assembled))
        self.assertEqual(
            "093fc4751ff7d121eb24a4538fc24a92477adeff59bbfdf522cf9bfc69b534b2",
