...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-session.js": (
                36_155,
                "966acf75800c20a6588ccad60238152b6a8da08d17ef92af0fd7d4ba9ec1f30e",
            ),
            "next-workstream.js": (
                18_659,
        ...
        self.assertEqual(910_419, len(assembled))
        self.assertEqual(
            "713f70f69eb48f85fa11f21e77f076879001b304c6d5d201660a67e25c8bd2a2",
