...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            "next-boot.js": (
                23_970,
                "773df10e37644834b70029833f38e7d800418754b81c3abc444470ef4d4a0df5",
            ),
            "next-observed.js": (
                30_213,
                "0b8259afbd480bd9bebcf2c2639f6f8e413c82a9ffca95e585292ea47b03bebe",
            ),
            "next-attention.js": (
                56_348,
            ...
            "next-project.js": (
                17_111,
                "fd86a588aedb4b4f64b9f31123ab940ba754365aa8da480c58534ec19029613a",
            ),
            "next-activity.js": (
                6_632,
            ...
            "next-cockpit.js": (
                114_695,
                "71df914b07617ebb0f11b990de26880faa149ca357095f7975f682ae67fa90e2",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(94_607, len(styles))
        self.assertEqual(
            "1c0edab66dc1c947648254f1877e99cef357e44a1ac15f56217e509163741873",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_page()
        self.assertEqual(754_115, len(assembled))
        self.assertEqual(
            "e9ff124ff5fca57afd9e8492f9bd0cde8be2682f087c80677bd3be1be5b9628a",
