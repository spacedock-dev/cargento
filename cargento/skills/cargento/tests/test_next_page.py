...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-chrome.js": (
                15_883,
                "49969cc3f58d8ee37f5bbb56b7e2d1ac5a1a79aa929eb86e9d4757e6dd5c921c",
            ),
            "next-sessions.js": (
                11_566,
        ...
        self.assertEqual(324_669, len(assembled))
        self.assertEqual(
            "ecfed6c1fd62dac273bd0750d44a359430006304b5cf08d49e2d4db0acb4727c",
