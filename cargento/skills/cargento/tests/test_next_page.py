...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-session.js": (
                8_577,
                "8ac8a163fe2199d013763c7ead343bd6f3b0e5e9cb20b3e1a016f73340e520d9",
            ),
            "next-workstream.js": (
                11_624,
        ...
        self.assertEqual(88_609, len(assembled))
        self.assertEqual(
            "14803d857070055dc743ec443c22c935dd5bc7189303544261e038fa2bbf1786",
