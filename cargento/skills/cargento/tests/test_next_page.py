...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            "next-boot.js": (
                23_583,
                "db61b108714fcbed2ff061d92676d1cf448da85420ca9092a285468aaa5b3c80",
            ),
            "next-observed.js": (
                29_647,
                "bd905311bda8a2800a1f02e54ae489c0ed802add1cedae2b5e7667a9f856c6e7",
            ),
            "next-attention.js": (
                56_348,
            ...
            "next-project.js": (
                15_236,
                "ea730da3183b038d7fb7b1d58c829a31bc1cdff6c215cbbf1a44f8c5d6a6fffe",
            ),
            "next-activity.js": (
                6_632,
            ...
            "next-cockpit.js": (
                82_266,
                "8bcf024b99698e6f3e922507d82b8a10e680056470ed04af7e4730a71d7a0068",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(89_083, len(styles))
        self.assertEqual(
            "20738b91c49528255900bd0feb31370dec08e321e903b9bbfc9e01976e830130",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_page()
        self.assertEqual(713_334, len(assembled))
        self.assertEqual(
            "1dfc7574028e4b552666603c5c2661ee2f5de7f11e0a06b839b690dafb165dcb",
