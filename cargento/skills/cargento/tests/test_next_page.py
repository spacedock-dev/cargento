...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                195_115,
                "6634723119d364c42d18e0bc059fa2891c0854524a2b55acca1c8be74d8bdd65",
            ),
            "next-render.js": (
                8_960,
        ...
        self.assertEqual(895_076, len(assembled))
        self.assertEqual(
            "e13a43677a70f8c7dad51af5793191d67c068d98e10a4cd7a6e4c41dfa85bb43",
