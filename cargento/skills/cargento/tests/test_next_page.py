...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-session.js": (
                8_263,
                "e4e4e150e5bd5adb21761dc61387cb03fba49a956f132c43bc47165d73b59169",
            ),
            "next-workstream.js": (
                11_624,
        ...
        self.assertEqual(88_295, len(assembled))
        self.assertEqual(
            "374ff795350f5d6ef6af032965cc6ec8b21741643595fa74a695dbf0137a1715",
