...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                112_426,
                "f57844df295aa375a8ef908785bcbb4a126c52f814b0deee2dddb778103965db",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(750_620, len(assembled))
        self.assertEqual(
            "76cf8f2c16081da360b4427cc375d4cccf65a6f97b36f0c4abd0da9f72b4faf0",
