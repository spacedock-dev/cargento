...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-delegation.js": (
                6_819,
                "db023a0e92feb80927588d2bebad36ec263b3aab86b375088c2ec4f51458088f",
            ),
            "next-controls.js": (
                6_777,
        ...
        self.assertEqual(224_454, len(assembled))
        self.assertEqual(
            "505110830e97c8b08c0f640220b171b0b46fc6b56c23587c35a46460a629622b",
