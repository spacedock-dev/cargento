...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                120_442,
                "521052263bb86606a759add519842af4a86ed462a227609a88a6aad9c1eb9c1f",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(762_168, len(assembled))
        self.assertEqual(
            "756fab722668909bd8a029b06b620ce46dd2ba42bfa61df0a452eb012e8a9888",
