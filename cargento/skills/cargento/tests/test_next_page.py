...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                131_872,
                "e80e69bc24cd5d6143c75eb405d0f31757dbb93768fa4a9d3f96b3014fe09e8b",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(776_565, len(assembled))
        self.assertEqual(
            "c25b08c37ae1f00d43621aecdb6787e291f7e016b39a767fc0f41feed21a28a4",
