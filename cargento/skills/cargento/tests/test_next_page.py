...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-project.js": (
                15_885,
                "3fd9677f7d53c53c4b6fac23e364a383d4c93248376b95dafed5891972a7a91b",
            ),
            "next-activity.js": (
                6_632,
            ...
            "next-cockpit.js": (
                108_932,
                "26e90b6c3bdfc68ad1772982062cba5be6cf87267f95fb20dcd2322fa20fff39",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(94_526, len(styles))
        self.assertEqual(
            "66b84c970c673b2125ee1cc17c133cea66051d50928f043cb558706518ddb916",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_page()
        self.assertEqual(747_045, len(assembled))
        self.assertEqual(
            "bcb92907ace8cf49e09c26f8ef8b5a1368982a27b453dee407e18f97dd55220f",
