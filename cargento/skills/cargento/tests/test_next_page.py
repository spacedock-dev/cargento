...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                165_935,
                "40eb7d1b79dd331b6a4d7ae3645a7c0ca37bd058333060f4da48fd98dd7664d8",
            ),
            "next-render.js": (
                8_901,
        ...
        self.assertEqual(837_393, len(assembled))
        self.assertEqual(
            "8ec7beb3da16600184932db01940020dd53f51cb6e59aaa8ca088716a9c03e69",
