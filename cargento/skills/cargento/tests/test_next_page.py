...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                132_154,
                "e21fadbd842bc89a13aaf3e6a151d1437edbcd3fb00c4cd9033f9d94fe27061b",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(97_259, len(styles))
        self.assertEqual(
            "c74813721163e56aa0207bf17106f88416522c4c85f06a084dc6ca730ac91b34",
            hashlib.sha256(styles).hexdigest(),
        )

        assembled = frontend_page.load_page()
        self.assertEqual(776_847, len(assembled))
        self.assertEqual(
            "85cdbd103d8a28d61062d8591eb9c88478e61992ea0b335d711b298671f85097",
