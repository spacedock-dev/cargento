...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-session.js": (
                17_023,
                "4d826cb33d78d188e334b796cfb70eb82f9d3c017a918e8c3155a863ae7177aa",
            ),
            "next-workstream.js": (
                11_696,
        ...
        self.assertEqual(323_856, len(assembled))
        self.assertEqual(
            "a6c6ec65898d92574a110e87beb9fe471d064e7c8606f7a2c2732788993883ac",
