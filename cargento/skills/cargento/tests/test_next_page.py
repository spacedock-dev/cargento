...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                251_876,
                "dd354a04b87f741232ce83fef791ce408c8a48aaf09a65c116fcd325e9dde3fd",
            ),
            "next-render.js": (
                12_231,
        ...
        self.assertEqual(1_091_148, len(assembled))
        self.assertEqual(
            "33ec0f4e9d7036f50e957628022025fae42a6c34a19afdea807cb4ae2fd5ccde",
