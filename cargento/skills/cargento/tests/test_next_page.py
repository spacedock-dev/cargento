...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-workstream.js": (
                16_096,
                "d478c2d580a7333f0cbfaede4e260ad57e77dbf59f5e7ff84ae9dd9670fac4b7",
            ),
            "next-delegation.js": (
                8_583,
        ...
        self.assertEqual(331_552, len(assembled))
        self.assertEqual(
            "c2c58b5f1ca8b9e7a40f917a067a86a50e29d816b419fb812ea9ff3d4d55016e",
