...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                193_104,
                "2ca9b7c5caba3b676f362ecd79df6fb4640232b006415832de9996655cf508f1",
            ),
            "next-render.js": (
                8_901,
        ...
        self.assertEqual(882_987, len(assembled))
        self.assertEqual(
            "b16eb673c0b64bb4f67af3a702200beda7085274866e74e04c105d02c1ff4652",
