...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                135_499,
                "41142903fd608975daa01eac71f348e0db22a86914b0fff9750e04d153561fec",
            ),
            "next-render.js": (
                8_630,
        ...
        self.assertEqual(781_450, len(assembled))
        self.assertEqual(
            "ff8ac9c74a07ddfe99d7cdd234b8fcd41da5b78b29936f0ace5ac12819ffb692",
