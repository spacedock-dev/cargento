...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-delegation.js": (
                6_985,
                "67994e5e6bf174ba7046524ff48ecb909d9c5712ead1fa904e4d5e4a39a111fb",
            ),
            "next-controls.js": (
                6_761,
        ...
        self.assertEqual(87_901, len(assembled))
        self.assertEqual(
            "4d7d3bd3f2c917f68dba69610f64c03dfcbb104d9cdc8d9ce6d577073fac6de2",
