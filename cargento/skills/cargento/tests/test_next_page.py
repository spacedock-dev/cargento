...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-cockpit.js": (
                157_821,
                "bb25e817786474c2fd8cb371c0f4eafb45474ec9b036d6f9c749e5907635c280",
            ),
            "next-render.js": (
                8_901,
        ...
        self.assertEqual(814_936, len(assembled))
        self.assertEqual(
            "67cd1e05c5d1bba322bfd0d3ddc2180efbd4aa8d7288af1cd70907bf008fa721",
