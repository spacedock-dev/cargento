...
class NextPageAssetContractTest(unittest.TestCase):
    ...
    def test_load_next_page_preserves_its_byte_oracles(self) -> None:
        ...
        expected_parts = {
            ...
            "next-delegation.js": (
                6_850,
                "bc9c9bd18e5de63fb918796225803f362bf89ba0a7927fb94118c1c064466b12",
            ),
            "next-controls.js": (
                6_761,
        ...
        self.assertEqual(87_766, len(assembled))
        self.assertEqual(
            "c17d6e7ddd9d0f3eefed2714d62786dc4be448aa80ebbff8a94ed8798bba2ff7",
