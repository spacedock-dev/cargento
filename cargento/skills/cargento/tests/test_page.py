...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        self.assertEqual(121_729, len(assembled))
        self.assertEqual(
            "da378eb6fb8f8dd15032a292dc95fdc94a57539d8c9fc30e3701dc2056b64784",
        ...
        expected_parts = {
            ...
            "usage.js": (
                11_128,
                "b33c1143722f5d9af377041578385d00e653411599802e489366c9f08dd13a6f",
            ),
            "controls.js": (
                3_382,
