...
class FrontendAssetContractTest(unittest.TestCase):
    ...
    def test_load_page_preserves_all_three_byte_oracles(self) -> None:
        ...
        self.assertEqual(122_649, len(assembled))
        self.assertEqual(
            "29922f3db0101d63b31fa4f8371bd9407b61276542f91e8d99182f784c35d8dc",
        ...
        expected_parts = {
            ...
            "usage.js": (
                11_589,
                "1fc661d30a0db7c8c7bb59cc32b35fb380e353b4bf0d0406d96d130e2db55f8e",
            ),
            "controls.js": (
                3_382,
