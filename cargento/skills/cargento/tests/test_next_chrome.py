...
""",
    ...
    def test_a_refused_raise_and_an_unavailable_one_do_not_wear_the_same_look(self) -> None:
        ...
        # v3 retired `--line2`; the quiet control boundary is now `--line`. The
        # trailing semicolon is load-bearing: without it `--line-hi`, the raised
        # boundary, would satisfy a test named for the quiet one.
