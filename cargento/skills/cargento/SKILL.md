...
| `--no-usage` | Never fetch vendor quota over the network for this run, regardless of the setting stored in the dashboard. Quota read from local disk (Codex) still shows. |
